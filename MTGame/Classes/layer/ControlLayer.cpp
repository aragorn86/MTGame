...
bool ControlLayer::init()
{
	...
	CCMenuItem *left = CCMenuItemFont::create("left", this, menu_selector(ControlLayer::menuCallBackMove) );
	CCMenuItem *right = CCMenuItemFont::create("right", this, menu_selector(ControlLayer::menuCallBackMove) );
	CCMenuItem *up = CCMenuItemFont::create("up", this, menu_selector(ControlLayer::menuCallBackMove) );
