...
CCAnimation* AnimationManager::createNPCAnimation()
{
	...
	CCSpriteFrame *frame0, *frame1, *frame2, *frame3;
	//第二个参数表示显示区域的x, y, width, height，根据direction来确定显示的y坐标
	frame0 = CCSpriteFrame::createWithTexture(heroTexture, cocos2d::CCRectMake(32*0, 0, 32, 32));
	frame1 = CCSpriteFrame::createWithTexture(heroTexture, cocos2d::CCRectMake(32*1, 0, 32, 32));
	frame2 = CCSpriteFrame::createWithTexture(heroTexture, cocos2d::CCRectMake(32*2, 0, 32, 32));
	frame3 = CCSpriteFrame::createWithTexture(heroTexture, cocos2d::CCRectMake(32*3, 0, 32, 32));
	CCArray *animFrames = new CCArray(4);
	animFrames->addObject(frame0);
	animFrames->addObject(frame1);
	animFrames->addObject(frame2);
